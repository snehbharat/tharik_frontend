...
export default function UpdateProjectModal({
  ...
  const validationRules = {
    ...
    location: {
      ...
      maxLength: 200,
      message: isArabic
        ? "الموقع مطلوب (2-200 حرف)"
        : "Location is required (2-200 characters)",
    },
    budget: {
      required: true,
      min: 1,
      max: 999999999,
      message: isArabic
        ? "الميزانية مطلوبة ويجب أن تكون أكبر من 0"
    ...
    profitMargin: {
      ...
      max: 100,
      message: isArabic
        ? "هامش الربح يجب أن يكون بين 0 و 100%"
  ...
  const formatProjectData = (project) => {
    ...
    return {
      ...
      client_name: selectedClient
        ? isArabic
          ? selectedClient.client_name_arb || selectedClient.client_name_eng
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const result = await ProjectServiceClient.updateProject(
        projectId,
        formattedData
      );
      alert(
        ...
        <div className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                {clients.map((client) => (
                  ...
                  >
                    {isArabic
                      ? client.client_name_arb || client.client_name_eng
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleFieldChange("budget", parseFloat(e.target.value) || "")
                }
                className={`w-full border rounded-lg px-3 py-2 ${
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              {editingProject.description?.length || 0}/500{" "}
