...
export const HourlyRateManagement = ({ isArabic }) => {
  ...
  const calculateMonthlyEquivalent = (
    ...
    const effectiveHourlyRate =
      totalHours > 0 ? totalMonthlyEquivalent / totalHours : 0;
  ...
  const handleAddRate = () => {
    ...
    alert(
      isArabic
        ? "تم إضافة معدل الأجر بنجاح!"
        : "Hourly rate added successfully!"
    );
  };
  ...
  const handleUpdateStandardHours = () => {
    ...
    alert(
      isArabic
        ? "تم تحديث الساعات القياسية بنجاح!"
        : "Standard hours updated successfully!"
    );
  };
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <div className="text-2xl font-bold text-blue-900">
                {hourlyRates.filter((r) => r.status === "active").length}
              </div>
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <div className="text-2xl font-bold text-green-900">
                {formatSAR(
                  hourlyRates.reduce((avg, rate) => avg + rate.hourlyWage, 0) /
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <div className="text-2xl font-bold text-purple-900">
                {standardHoursConfig.standardHoursPerMonth}
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                    ...
                    <div
                      ...
                      className={`p-4 rounded-lg border-2 cursor-pointer transition-all ${
                        calculationInputs.selectedMultiplier === multiplier.id
                          ? getMultiplierColor(multiplier.multiplier) +
                ...
                <div className="mt-6 p-4 bg-white rounded-lg border border-gray-200">
                  ...
                  {(() => {
                    const selected = overtimeMultipliers.find(
                      (m) => m.id === calculationInputs.selectedMultiplier
                    );
                    return selected ? (
                      <div className="flex items-center gap-4">
                        <span
                          className={`px-3 py-1 rounded-full text-sm font-semibold border ${getMultiplierColor(
                            selected.multiplier
                          )}`}
                        >
                          {selected.multiplier.toFixed(2)}x -{" "}
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-yellow-700">
                      <li>
                        •{" "}
                        {isArabic
                          ? "الحد الأدنى: 18.00 ريال"
                          : "Minimum: 18.00 SAR"}
                      </li>
                      <li>
                        •{" "}
                        {isArabic
                          ? "الحد الأقصى: 500.00 ريال"
                          : "Maximum: 500.00 SAR"}
                      </li>
                      <li>
                        •{" "}
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-yellow-700">
                      <li>
                        •{" "}
                        {isArabic
                          ? "الحد الأدنى: 1.5x (قانون سعودي)"
                          : "Minimum: 1.5x (Saudi law)"}
                      </li>
                      <li>
                        •{" "}
                        {isArabic
                          ? "العمل الليلي: +25% إضافي"
                          : "Night shift: +25% additional"}
                      </li>
                      <li>
                        • {isArabic ? "عمل العطل: 2.0x" : "Holiday work: 2.0x"}
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-lg p-6 border border-green-200">
                <h3 className="text-xl font-semibold text-gray-900 mb-6 flex items-center gap-2">
                  ...
                  {isArabic
                    ? "حاسبة الراتب الشهري المكافئ"
                    : "Monthly Salary Equivalent Calculator"}
                </h3>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-center border-t border-gray-200 pt-3">
                          ...
                          <span className="text-xl font-bold text-green-600">
                            {formatSAR(
                              monthlyCalculation.totalMonthlyEquivalent
                            )}
                          </span>
                        </div>
                        <div className="flex justify-between items-center">
                        ...
                        {monthlyCalculation.overtimePay > 0 && (
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm">
                              ...
                              {(
                                (monthlyCalculation.overtimePay /
                                  monthlyCalculation.totalMonthlyEquivalent) *
                                100
                              ).toFixed(1)}
                              %)
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewRate({ ...newRate, employeeName: e.target.value })
                    }
                    className="w-full border border-gray-300 rounded-lg px-3 py-2"
                    required
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewRate({ ...newRate, employeeNameAr: e.target.value })
                    }
                    className="w-full border border-gray-300 rounded-lg px-3 py-2"
                  />
                </div>
