...
export const API_CONFIG = {
  ...
  BASE_URL: import.meta.env.VITE_API_BASE_URL || "http://31.97.203.245:3001/api",
  TIMEOUT: 30000,
  RETRY_ATTEMPTS: 3,
  RETRY_DELAY: 1000,
};
...
export const BUSINESS_RULES = {
  ...
  MINIMUM_WAGE: 18.0, // SAR per hour
  MAXIMUM_WAGE: 500.0, // SAR per hour
...
export const ERROR_MESSAGES = {
  ...
  BELOW_MINIMUM_WAGE:
    "Hourly rate cannot be below Saudi minimum wage (18.00 SAR)",
  ...
  INVALID_FILE_TYPE:
    "File type not supported. Please upload PDF, DOC, or image files.",
};
