...
export const generateSampleData = () => {
  const employees = [
    ...
    },
    {
      ...
      certifications: [
        "Automotive Technician License",
        "Hydraulic Systems Certificate",
      ],
  ...
  const projects = [
    {
      ...
      progress: 75,
      description:
        "Comprehensive maintenance services for Aramco facilities including equipment servicing, safety inspections, and preventive maintenance programs. This project involves maintaining critical infrastructure and ensuring operational continuity.",
      requirements: [
      ...
      statusHistory: [
        {
          ...
          progress: 75,
          notes:
            "Project progressing well, ahead of schedule. Team performance excellent.",
          ...
          followUp: {
            ...
            actionDescription:
              "Review quarterly performance metrics and plan next phase",
            priority: "medium",
            isCompleted: false,
            escalationLevel: 0,
          },
    ...
    },
    {
      ...
      progress: 60,
      description:
        "Construction support services for SABIC industrial expansion including structural work, electrical installations, and safety compliance. Focus on quality delivery and timeline adherence.",
      requirements: [
        "Construction crew",
    ...
    },
    {
      ...
      progress: 35,
      description:
        "Infrastructure development support for NEOM mega-project including road construction, utility installations, and environmental compliance. This is a flagship project requiring highest standards.",
      requirements: [
        "Large workforce",
        "Heavy machinery",
      ...
      statusHistory: [
        {
          ...
          progress: 35,
          notes:
            "Challenging terrain but making steady progress. Additional resources may be needed.",
          ...
          followUp: {
            ...
            actionDescription:
              "Assess resource requirements and timeline adjustments",
            priority: "high",
            isCompleted: false,
            escalationLevel: 1,
          },
